...
#define CHASSIS_VX_CHANNEL 0
#define CHASSIS_VY_CHANNEL 2
...
#define CHASSIS_WZ_RC_SEN 0.0009f
...
#define PITCH_PALSTANCE_PID_KP        1000.0f
#define PITCH_PALSTANCE_PID_KI        5.0f
...
//底盘电机位置环PID
#define M3505_MOTOR_POSITION_PID_KP 5.0f
#define M3505_MOTOR_POSITION_PID_KI 0.0f
#define M3505_MOTOR_POSITION_PID_KD 1.0f
#define M3505_MOTOR_POSITION_PID_MAX_OUT   5.0f//从320 改成390 ，力大概从15000变成16000左右
#define M3505_MOTOR_POSITION_PID_MAX_IOUT   0.0f
...
typedef struct
{
  ...
  pid_type_def motor_speed_pid[2];             //motor speed PID.底盘电机速度pid
	pid_type_def motor_position_pid[2]; 
	pid_type_def motor_palstance_pid[2]; 
  ...
  fp32 chassis_pitch_set;   
	fp32 motor_pitch_palstance;         //rad/s
  fp32 motor_pitch_palstance_set[2];
